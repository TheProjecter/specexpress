...
namespace SpecExpress.Rules.DateValidators
{
    ...
    {
        public static ActionJoinBuilder<T, DateTime> IsBefore<T>(this IRuleBuilder<T, DateTime> expression, DateTime beforeDate)
        {
            expression.RegisterValidator(new IsBefore<T>(beforeDate));
            return expression.JoinBuilder;
        }

        public static ActionJoinBuilder<T, DateTime> IsAfter<T>(this IRuleBuilder<T, DateTime> expression, DateTime afterDate)
        {
